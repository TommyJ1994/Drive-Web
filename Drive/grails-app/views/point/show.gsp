	...
	<body>
		...
		<div id="show-point" class="content scaffold-show" role="main">
			...
			<ol class="property-list point">
				...
				<g:if test="${pointInstance?.sensor}">
				<li class="fieldcontain">
					<span id="sensor-label" class="property-label"><g:message code="point.sensor.label" default="Sensor" /></span>
					
						<span class="property-value" aria-labelledby="sensor-label"><g:link controller="sensor" action="show" id="${pointInstance?.sensor?.id}">${pointInstance?.sensor?.encodeAsHTML()}</g:link></span>
			...
			<g:form url="[resource:pointInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${pointInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
